...
class ServicioHospedaje extends React.Component{
    componentDidMount() {
                            ...
                            <div className="row row-cols-1 row-cols-md-3 g-7">
                                <div>
                                    <div className="card my-4 ">
                                        <Link to='/tablahospedajes'>
                                            <img src={IconTable} className="card-img-top" alt="..." width="250" height="180"/>
                                        </Link>
                                        <div className="card-body">
                                            <h6 className="card-text">Tabla Hospedajes</h6>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div className="card my-4 ">
                                        <Link to='/agregarhospedaje'>
                                            <img src={IconAdd} className="card-img-top" alt="..." width="250" height="180"/>
                                        </Link>
                                        <div className="card-body">
                                            <h6 className="card-text">Agregar Hospedaje</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default ServicioHospedaje;